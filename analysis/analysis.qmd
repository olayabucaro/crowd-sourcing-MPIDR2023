...
#data <- fread("N:/Incubator2023_crowd/moddata/moddatafinal_LASTTIMEIPROMISE.csv")
...
m1 <- brm(deathage ~ migrant * birth10 + firstmale + sib_size_cat + (1|famid), 
          data = data, cores = 4, seed = 1337)
