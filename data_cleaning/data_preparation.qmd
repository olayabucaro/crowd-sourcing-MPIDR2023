...
fwrite(data, paste0(params$save_path, "moddata1.csv")) # Data without coordinate matching
fwrite(data_recoded, paste0(params$save_path, "moddata2.csv")) # Data with coordinate matching
