...
Load necessary packages and paths to raw data in N drive and save location of cleaned file
...
### Save moddata1 data to file (without coordiate matching)
...
### Save moddata2 data to file (With coordiate matching using Low (mid) resolution World Map)
